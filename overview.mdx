...
<Columns cols={(2, 2)}>
  ...
  >
    ...
    source doc hub and start getting usage.
  </Card>
  <Card
    title="Start Earning"
    icon="hand-coins"
    ...
    arrow="true"
  >
    Once your template gets usage, get verified to monetize your published docs.
  </Card>
  <Card
    ...
    arrow="true"
  >
    Learn about the verification process to start earning from your templates.
  </Card>
  <Card

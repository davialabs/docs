...
<Card
  ...
  img="images/single-page-app-light.png"
  title="Interactive Document Example"
>
  In this _Weekly Planner_, the title and the _how to use_ sections are editable
  content. The planner in the center is an interactive component.
</Card>
...
<Columns cols={2}>
  ...
  <Card title="On the left side of the screen your workspace">
    <br />
    Whether you have a page with multiple components or just notes, each on of them

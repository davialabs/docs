...
<Steps>
  ...
  <Step title="Initialize Davia with your coding agent">
    ...
    Replace <code>[name of your coding agent]</code> with something like:
    ...
    This links your project’s Davia workspace to the agent that will generate your documentation.
  ...
  <Step title="Generate documentation with your AI agent">
    ...
    > “Generate an interactive documentation for this project, including visualizations and editable whiteboards.”

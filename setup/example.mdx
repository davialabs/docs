...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/ZsooGrGWDOs?si=WrU1cx5xa8bokR--"
...
The final goal is people, not companies. While you can perform broader searches if needed, ensure that the final result consists of individual people. 

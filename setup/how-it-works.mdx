...
- `@app.task` — for any standalone function (e.g. generate a report, summarize text, send a Slack message)
- `@app.graph` — for structured AI agents using LangGraph or CrewAI
